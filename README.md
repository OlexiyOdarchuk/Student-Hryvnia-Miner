...
SHMiner фокусується на шаленійі ефективності, зручному інтерфейсі, безпечному локальному зберіганні гаманців та надійній взаємодії з мережевими вузлами. Усі ваші дані (гаманці, конфігурація) зберігаються виключно локально у зашифрованому вигляді — додаток не залежить від сторонніх серверів для авторизації.
...
Перед першим запуском встановіть залежності фронтенду:
...
Щоб створити готовий бінарний файл або інсталятор для вашої ОС (без вікон консолі та з мінімізацією розміру):
